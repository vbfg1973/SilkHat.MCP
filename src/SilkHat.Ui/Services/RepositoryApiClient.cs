    ...
    public sealed class RepositoryApiClient
    {
            ...
            CancellationToken cancellationToken = default)
        {
            return await GetFromJsonAsync<PagedResultModel<RepositoryGroupModel>>(
                       ...
                       cancellationToken)
                   ?? new PagedResultModel<RepositoryGroupModel>(new List<RepositoryGroupModel>(), DefaultPageNumber,
                       DefaultPageSize, 0);
        }

        public async Task<RepositoryGroupModel> CreateRepositoryGroupAsync(CreateRepositoryGroupRequest request,
            CancellationToken cancellationToken = default)
        {
            var response = await _httpClient.PostAsJsonAsync("api/repository-groups", request, cancellationToken);
            response.EnsureSuccessStatusCode();
            return (await response.Content.ReadFromJsonAsync<RepositoryGroupModel>(cancellationToken))!;
        }

        public async Task<RepositoryGroupModel> UpdateRepositoryGroupAsync(Guid id,
            UpdateRepositoryGroupRequest request, CancellationToken cancellationToken = default)
        {
            ...
            CancellationToken cancellationToken = default)
        {
            return await GetFromJsonAsync<PagedResultModel<RepositoryConfigModel>>(
                       "api/repositories",
                       cancellationToken)
                   ?? new PagedResultModel<RepositoryConfigModel>(new List<RepositoryConfigModel>(), DefaultPageNumber,
                       DefaultPageSize, 0);
        }
            ...
            CancellationToken cancellationToken = default)
        {
            return await GetFromJsonAsync<PagedResultModel<AvailableRepositoryModel>>(
                       ...
                       cancellationToken)
                   ?? new PagedResultModel<AvailableRepositoryModel>(new List<AvailableRepositoryModel>(),
                       DefaultPageNumber, DefaultPageSize, 0);
        }
            ...
            CancellationToken cancellationToken = default)
        {
            ...
            return await GetFromJsonAsync<PagedResultModel<AvailableRepositorySolutionModel>>(url, cancellationToken)
                   ?? new PagedResultModel<AvailableRepositorySolutionModel>(
                       new List<AvailableRepositorySolutionModel>(), DefaultPageNumber, DefaultPageSize, 0);
        }

        public async Task<RepositoryConfigModel> CreateRepositoryConfigAsync(CreateRepositoryConfigRequest request,
            CancellationToken cancellationToken = default)
        {
            var response = await _httpClient.PostAsJsonAsync("api/repositories", request, cancellationToken);
            response.EnsureSuccessStatusCode();
            return (await response.Content.ReadFromJsonAsync<RepositoryConfigModel>(cancellationToken))!;
        }

        public async Task<RepositoryConfigModel> UpdateRepositoryConfigAsync(Guid id,
            UpdateRepositoryConfigRequest request, CancellationToken cancellationToken = default)
        {
        ...
        public async Task<RepositoryGroupLoadResultModel> LoadRepositoryGroupAsync(Guid id,
            CancellationToken cancellationToken = default)
        {
            var response = await _httpClient.PostAsync($"api/repository-groups/{id}/load", null, cancellationToken);
            response.EnsureSuccessStatusCode();
            return (await response.Content.ReadFromJsonAsync<RepositoryGroupLoadResultModel>(cancellationToken))!;
        }
            ...
            CancellationToken cancellationToken = default)
        {
            ...
            return await GetFromJsonAsync<PagedResultModel<CodeSolutionModel>>(url, cancellationToken)
                   ?? new PagedResultModel<CodeSolutionModel>(new List<CodeSolutionModel>(), DefaultPageNumber,
                       DefaultPageSize, 0);
        }
            ...
            CancellationToken cancellationToken = default)
        {
            ...
            return await GetFromJsonAsync<PagedResultModel<CodeProjectDto>>(url, cancellationToken)
                   ?? new PagedResultModel<CodeProjectDto>(new List<CodeProjectDto>(), DefaultPageNumber,
                       DefaultPageSize, 0);
        }
            ...
            CancellationToken cancellationToken = default)
        {
            ...
            if (!string.IsNullOrWhiteSpace(parentId)) query.Add($"parentId={Uri.EscapeDataString(parentId)}");
            ...
            if (filterThreshold is not null) query.Add($"filterThreshold={filterThreshold.Value}");

            if (query.Count > 0) url += "?" + string.Join("&", query);

            return await GetFromJsonAsync<PagedResultModel<CodeTreeEntryModel>>(url, cancellationToken)
                   ?? new PagedResultModel<CodeTreeEntryModel>(new List<CodeTreeEntryModel>(), DefaultPageNumber,
                       DefaultPageSize, 0);
        }
        ...
        {
            var url =
                $"api/repositories/{repositoryId}/code/solutions/{solutionId}/files?path={Uri.EscapeDataString(displayPath)}";
        ...
        {
            var url =
                $"api/repositories/{repositoryId}/code/solutions/{solutionId}/files/symbols?path={Uri.EscapeDataString(repositoryPath)}";
            ...
            CancellationToken cancellationToken = default)
        {
            var response = await _httpClient.PostAsJsonAsync(
                ...
                cancellationToken);
            response.EnsureSuccessStatusCode();
            return (await response.Content.ReadFromJsonAsync<MethodCallStackResponseModel>(cancellationToken))!;
        }
            ...
            CancellationToken cancellationToken = default)
        {
            var response = await _httpClient.PostAsJsonAsync(
                ...
                cancellationToken);
            response.EnsureSuccessStatusCode();
            return (await response.Content.ReadFromJsonAsync<MethodCallStackMermaidModel>(cancellationToken))!;
        }
            ...
            CancellationToken cancellationToken = default)
        {
            var response = await _httpClient.PostAsJsonAsync(
                ...
                cancellationToken);
            response.EnsureSuccessStatusCode();
            return (await response.Content.ReadFromJsonAsync<MethodImplementationDecisionModel>(cancellationToken))!;
        }
        ...
        {
            var query = new List<string>();
            if (type.HasValue) query.Add($"type={Uri.EscapeDataString(type.Value.ToString())}");

            if (!string.IsNullOrWhiteSpace(sort)) query.Add($"sort={Uri.EscapeDataString(sort)}");

            if (descending) query.Add("descending=true");
            ...
            CancellationToken cancellationToken = default)
        {
            var response = await _httpClient.PostAsJsonAsync(
                ...
                cancellationToken);
            response.EnsureSuccessStatusCode();
            return (await response.Content.ReadFromJsonAsync<IReadOnlyList<DecisionSummaryModel>>(cancellationToken))!
                   ?? Array.Empty<DecisionSummaryModel>();
        }
            ...
            CancellationToken cancellationToken = default)
        {
            var response = await _httpClient.PostAsJsonAsync(
                ...
                cancellationToken);
            response.EnsureSuccessStatusCode();
            return (await response.Content.ReadFromJsonAsync<DecisionSummaryModel>(cancellationToken))!;
        }
            ...
            CancellationToken cancellationToken = default)
        {
            ...
            return await GetFromJsonAsync<PagedResultModel<GitTreeEntryModel>>(url, cancellationToken)
                   ?? new PagedResultModel<GitTreeEntryModel>(new List<GitTreeEntryModel>(), DefaultPageNumber,
                       DefaultPageSize, 0);
        }
        ...
        {
            var url =
                $"api/repositories/{repositoryId}/git/files/{Uri.EscapeDataString(path)}/last-change?includeDiff={includeDiff.ToString().ToLowerInvariant()}";
            ...
            [EnumeratorCancellation] CancellationToken cancellationToken = default)
        {
            ...
            await foreach (var evt in ReadNdjsonAsync<RepoEventModel>(stream, cancellationToken)) yield return evt;
        }
