...
public sealed record LoadCallStackAction(string SolutionId, Guid ConfigId, string? DocumentationId, string SymbolKey, int? MaxDepth, bool IncludeExternalCalls);
...
public sealed record LoadCallStackMermaidAction(string SolutionId, Guid ConfigId, string? DocumentationId, string SymbolKey, int? MaxDepth, bool IncludeExternalCalls);
...
public sealed record SetCallStackIncludeExternalAction(string SolutionId, bool IncludeExternalCalls);
