...
namespace SilkHat.Ui.State.Ide.Actions
{
    ...
    public sealed record LoadCallStackAction(
        string SolutionId,
        Guid ConfigId,
    ...
    public sealed record LoadCallStackSuccessAction(
        string SolutionId,
        string? DocumentationId,
        string SymbolKey,
        IReadOnlyList<MethodCallStackNodeModel> Nodes);

    public sealed record LoadCallStackFailureAction(
        string SolutionId,
        string? DocumentationId,
        string SymbolKey,
        string Error);

    public sealed record LoadCallStackMermaidAction(
        string SolutionId,
        Guid ConfigId,
        string? DocumentationId,
        string SymbolKey,
    ...
    public sealed record LoadCallStackMermaidSuccessAction(
        string SolutionId,
        string? DocumentationId,
        string SymbolKey,
        string Diagram);

    public sealed record LoadCallStackMermaidFailureAction(
        string SolutionId,
        string? DocumentationId,
        string SymbolKey,
        string Error);
