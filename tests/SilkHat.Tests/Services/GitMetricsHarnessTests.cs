...
";
        ...
        {
            authors.Add(commit.AuthorEmail ?? commit.AuthorName);
        }
    ...
    private sealed class FakeGitCommandRunner : IGitCommandRunner
    {
        ...
        public Task<GitCommandResult> ExecuteAsync(string repoRoot, string[] args, System.Threading.CancellationToken cancellationToken)
        {
