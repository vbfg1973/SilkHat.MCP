...
namespace SilkHat.Api.Tests.Services
{
    public sealed class CodeTreeMetricsServiceTests
    {
        ...
        public async Task GetMetricsAsync_UsesGitMetrics_ForFileCounts()
        {
            ...
            gitAggregator
                .Setup(service =>
                    service.GetMetricsAsync(It.IsAny<Guid>(), workspace.RootPath, It.IsAny<CancellationToken>()))
        ...
        public async Task GetMetricsAsync_UsesComplexityMetrics_ForFileComplexity()
        {
            ...
            var fileMetrics = new FileComplexityMetrics(
                ...
                new Dictionary<ComplexityMeasureType, IReadOnlyDictionary<string, int>>
                {
                    [ComplexityMeasureType.Cognitive] = new Dictionary<string, int>(),
                    [ComplexityMeasureType.Cyclomatic] = new Dictionary<string, int>(),
                    [ComplexityMeasureType.Indentation] = new Dictionary<string, int>()
                },
                new Dictionary<ComplexityMeasureType, IReadOnlyDictionary<string, int>>
                {
                    [ComplexityMeasureType.Cognitive] = new Dictionary<string, int>(),
            ...
            complexityAggregator
                .Setup(service =>
                    service.GetMetricsAsync(It.IsAny<Guid>(), workspace, solution, It.IsAny<CancellationToken>()))
        ...
        {
            var project = new CodeTreeEntryDto("./Repo", "Repo", "Repo", CodeTreeEntryType.Project, "alpha", "Repo",
                null, null, null, null, null, null);
            var folder = new CodeTreeEntryDto("./Repo/Foo", "Repo/Foo", "Foo", CodeTreeEntryType.Directory, "alpha",
                "Repo", null, null, null, null, null, null);
            var fileOne = new CodeTreeEntryDto("./Repo/Foo/A.cs", "Repo/Foo/A.cs", "A.cs", CodeTreeEntryType.File,
                "alpha", "Repo", null, null, null, null, null, null);
            var fileTwo = new CodeTreeEntryDto("./Repo/Bar.cs", "Repo/Bar.cs", "Bar.cs", CodeTreeEntryType.File,
                "alpha", "Repo", null, null, null, null, null, null);
