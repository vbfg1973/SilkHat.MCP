    ...
    public sealed class CodeTreeQueryServiceTests
    {
        ...
        public async Task GetTreeAsync_AnnotatesChildren_WhenParentSpecified()
        {
            ...
            Assert.All(result.Items,
                entry => Assert.Equal(CodeTreeAnnotationKind.CyclomaticComplexity, entry.AnnotationKind));
        }
            ...
            IReadOnlyDictionary<string, IReadOnlyList<CodeTreeEntryDto>> children)
        {
            ...
            var solutionNode = new GraphNodeDto(Guid.NewGuid(), GraphNodeKind.Solution, solution.SolutionId,
