...
public sealed class DecisionsControllerTests
{
    ...
    public async Task GetPending_ReturnsDecisions_AndCallsService()
    {
        ...
        {
            new(Guid.NewGuid(), DecisionType.ResolveInterface, DecisionStatus.Pending, false, true, "IGreetingProvider",
                "M:Samples.IGreetingProvider.GetGreeting(System.String)", DateTimeOffset.UtcNow, null, null, new object())
        };
