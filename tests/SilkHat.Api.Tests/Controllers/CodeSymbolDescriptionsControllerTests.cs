...
public sealed class CodeSymbolDescriptionsControllerTests
{
    ...
    public async Task GetNamedType_ReturnsDescription_AndCallsService()
    {
        ...
        var result = await controller.GetNamedType(workspaceId, solutionId, "T:Sample.Type", CancellationToken.None);
    ...
    public async Task GetMethod_ReturnsDescription_AndCallsService()
    {
        ...
        var result = await controller.GetMethod(workspaceId, solutionId, "M:Sample.Type.Run", CancellationToken.None);
    ...
    public async Task GetProperty_ReturnsDescription_AndCallsService()
    {
        ...
        var result = await controller.GetProperty(workspaceId, solutionId, "P:Sample.Type.Value", CancellationToken.None);
    ...
    public async Task GetField_ReturnsDescription_AndCallsService()
    {
        ...
        var result = await controller.GetField(workspaceId, solutionId, "F:Sample.Type.Field", CancellationToken.None);
    ...
    public async Task GetEvent_ReturnsDescription_AndCallsService()
    {
        ...
        var result = await controller.GetEvent(workspaceId, solutionId, "E:Sample.Type.Changed", CancellationToken.None);
    ...
    {
        var symbolService = new Mock<ISymbolDescriptionService>();
        var controller = new CodeSymbolDescriptionsController(new Mock<ICodeWorkspaceStore>().Object, symbolService.Object)
        {
            ControllerContext = ControllerTestFactory.CreateContext()
        };

        var result = await controller.GetNamedType(Guid.NewGuid(), solutionId, "T:Sample.Type", CancellationToken.None);
