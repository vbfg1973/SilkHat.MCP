...
public sealed class CodeSymbolsControllerTests
{
    ...
    public void LookupSymbol_ReturnsProblem_WhenWorkspaceMissing()
    {
        ...
        var result = controller.LookupSymbol(Guid.NewGuid(), new SymbolLookupRequest("sym", "NamedType"));
    ...
    public void LookupSymbol_ReturnsMatch_WhenFound()
    {
        ...
        var result = controller.LookupSymbol(Guid.NewGuid(), new SymbolLookupRequest("sym-alpha", "Class"));
