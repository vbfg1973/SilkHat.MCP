    ...
    public sealed class DecisionToolboxTests
    {
        ...
        public void DecisionToolboxContent_RendersPendingDecision()
        {
            ...
            var payload = new ResolveInterfaceDecisionPayloadModel(
                ...
                {
                    new("Samples.FriendlyGreetingProvider", "T:Samples.FriendlyGreetingProvider",
            ...
            var decisionsState = new IdeDecisionsState(
                new Dictionary<string, IdeDecisionsViewState>(StringComparer.OrdinalIgnoreCase)
                {
            ...
            context.Services.AddScoped<IState<IdeDecisionsState>>(_ =>
                new StateWrapper<IdeDecisionsState>(decisionsState));
