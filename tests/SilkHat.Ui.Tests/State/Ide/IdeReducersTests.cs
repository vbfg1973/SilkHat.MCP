...
namespace SilkHat.Ui.Tests.State.Ide
{
    public sealed class IdeReducersTests
    {
        ...
        public void SolutionsReducer_LoadsAndSelects()
        {
            ...
            {
                new("solution-1", "./RepoOne.sln", "./RepoOne.sln", "Repo One", Guid.NewGuid(),
                    "./RepoOne.sln (Repo One)")
            };
            var loaded =
                IdeSolutionsReducers.ReduceLoadSolutionsSuccess(initial, new LoadSolutionsSuccessAction(solutions));
        ...
        public void TreeReducer_LoadsRootAndChildren()
        {
            ...
            var loaded =
                IdeTreeReducers.ReduceLoadRootSuccess(state, new LoadTreeRootSuccessAction("solution-1", rootItems));
            ...
            var childItems = new List<TreeItemData<CodeTreeEntryModel>>
            {
                new()
                {
                    Value = new CodeTreeEntryModel("./RepoOne/Program.cs", "Repo One/Program.cs", "Program.cs",
                        CodeTreeEntryType.File, "alpha", "Repo One", null, null, null, null, null, null),
                    Text = "Program.cs"
                }
            };
        ...
        public void TabsReducer_TogglesDiff()
        {
            ...
            {
                ["solution-1"] = new(new List<IdeOpenFileTab>
                {
